...
const WhatsAppButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-6 md:bottom-8 right-6 md:right-8 bg-accent text-surface p-4 md:p-5 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 z-40 hover:scale-105"
